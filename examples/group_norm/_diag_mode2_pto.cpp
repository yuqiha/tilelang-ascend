...
extern "C" __global__ AICORE void main_kernel(__gm__ uint8_t *x_handle_raw, __gm__ uint8_t *gamma_handle_raw, __gm__ uint8_t *beta_handle_raw, __gm__ uint8_t *y_handle_raw, uint64_t ffts_Addr) {
  ...
  if (vid == 0) {
      ...
      TEXPANDS(sum_row, 0.000000e+00f);
      set_flag(PIPE_V, PIPE_S, EVENT_ID0);
      wait_flag(PIPE_V, PIPE_S, EVENT_ID0);
      TEXPANDS(sum_sq_row, 0.000000e+00f);
      set_flag(PIPE_V, PIPE_S, EVENT_ID0);
      wait_flag(PIPE_V, PIPE_S, EVENT_ID0);
      TEXPANDS(total, 0.000000e+00f);
      set_flag(PIPE_V, PIPE_S, EVENT_ID0);
      wait_flag(PIPE_V, PIPE_S, EVENT_ID0);
      TEXPANDS(total_sq, 0.000000e+00f);
      set_flag(PIPE_V, PIPE_S, EVENT_ID0);
      wait_flag(PIPE_V, PIPE_S, EVENT_ID0);
      TEXPANDS(mean_sq_val, 0.000000e+00f);
      set_flag(PIPE_V, PIPE_S, EVENT_ID0);
      wait_flag(PIPE_V, PIPE_S, EVENT_ID0);
      TEXPANDS(var_val, 0.000000e+00f);
      set_flag(PIPE_V, PIPE_S, EVENT_ID0);
      wait_flag(PIPE_V, PIPE_S, EVENT_ID0);
      TEXPANDS(std_val, 0.000000e+00f);
      set_flag(PIPE_V, PIPE_S, EVENT_ID0);
      wait_flag(PIPE_V, PIPE_S, EVENT_ID0);
  ...
  for (int32_t si = 0; si < 2; ++si) {
      ...
      set_flag(PIPE_V, PIPE_S, EVENT_ID0);
      wait_flag(PIPE_V, PIPE_S, EVENT_ID0);
      TEXPANDS(out_a, mean_sq_val.GetValue(0));
      set_flag(PIPE_V, PIPE_S, EVENT_ID0);
      wait_flag(PIPE_V, PIPE_S, EVENT_ID0);
      TEXPANDS(out_b, var_val.GetValue(0));
      pipe_barrier(PIPE_ALL);
